    ...
    public partial class Inicio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FotosAnimal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FotosAnimal_Animals_AnimalId",
                        column: x => x.AnimalId,
